...
class PostController extends Controller
{
    ...
    public function renderArchive(array $criteria = array(), array $parameters = array(), Request $request = null)
    {
        ...
        $response = $this->render(sprintf('BrotherCommentBundle:Post:archive.%s.twig', $request->getRequestFormat()), $parameters);
    ...
    public function commentsAction($postId)
    {
        ...
        return $this->render('BrotherCommentBundle:Post:comments.html.twig', array(
            'pager'  => $pager,
        ));
    }
    ...
    public function addCommentFormAction($postId, $form = false)
    {
        ...
        return $this->render('BrotherCommentBundle:Post:comment_form.html.twig', array(
