...
namespace Brother\CommentBundle\Tests\Model;

class ModelTest_Comment extends \Brother\CommentBundle\Model\Comment
{
...
class CommentTest extends \PHPUnit_Framework_TestCase
{
    public function testSettersGetters()
    {
        ...
        $comment->setPost($this->getMock('Brother\CommentBundle\Model\PostInterface'));
        $comment->setStatus(1);
        ...
        $this->assertEquals($comment->getPost(), $this->getMock('Brother\CommentBundle\Model\PostInterface'));
