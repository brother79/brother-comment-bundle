...
namespace Brother\CommentBundle\Tests\Entity;

use Sonata\CoreBundle\Test\EntityManagerMockFactory;
use Brother\CommentBundle\Entity\PostManager;
...
class PostManagerTest extends \PHPUnit_Framework_TestCase
{
    protected function getPostManager($qbCallback)
    {
        ...
        return new PostManager('Brother\CommentBundle\Entity\BasePost', $registry);
    }
