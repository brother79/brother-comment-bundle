...
namespace Brother\CommentBundle\Tests\Controller\Api;

use Brother\CommentBundle\Controller\Api\PostController;
...
class PostControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $post = $this->getMock('Brother\CommentBundle\Model\PostInterface');
    ...
    public function testGetPostCommentsAction()
    {
        ...
        $commentManager = $this->getMock('Brother\CommentBundle\Model\CommentManagerInterface');
    ...
    {
        $comment = $this->getMock('Brother\CommentBundle\Model\CommentInterface');
        $post = $this->getMock('Brother\CommentBundle\Model\PostInterface');
        ...
        $mailer = $this->getMock('Brother\CommentBundle\Mailer\MailerInterface');
