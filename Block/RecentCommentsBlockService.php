...
namespace Brother\CommentBundle\Block;
...
class RecentCommentsBlockService extends BaseBlockService
{
    ...
    public function buildEditForm(FormMapper $formMapper, BlockInterface $block)
    {
        $formMapper->add('settings', 'sonata_type_immutable_array', array(
            ...
            'translation_domain' => 'BrotherCommentBundle',
        ));
    }
    ...
    public function configureSettings(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            ...
            'template'   => 'BrotherCommentBundle:Block:recent_comments.html.twig',
        ));
    }
    ...
    {
        return new Metadata($this->getName(), (!is_null($code) ? $code : $this->getName()), false, 'BrotherCommentBundle', array(
