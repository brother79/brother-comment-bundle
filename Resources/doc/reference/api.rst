...
BrotherCommentBundle embeds a Controller to provide an API through FOSRestBundle, with its documentation provided by NelmioApiDocBundle.
...
.. code-block:: yaml
    ...
    sonata_api_news:
        type:         rest
        prefix:       /api
        resource:     "@BrotherCommentBundle/Resources/config/routing/api.xml"
